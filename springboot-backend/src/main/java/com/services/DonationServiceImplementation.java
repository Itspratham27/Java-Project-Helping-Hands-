...
public class DonationServiceImplementation implements DonationServices{
	...
	@Override
	public List<Donation> mainSearchValue(int id) {
		return DonationRepo.getItByValue(id);
	}



	@Override
	public List<Donation> mainSearchTypeDay(String name) {
		return DonationRepo.getNameValue(name);
	}
