...
public class DonorServiceImplementation implements DonorServices{
	...
	@Override
	public List<Donor> mainSearchValued(int id) {
		return DonorRepo.getItByValued(id);
	}

	@Override
	public List<Donor> getByTypeName(String name) {
		return DonorRepo.getNameValue(name);
	}	
}
