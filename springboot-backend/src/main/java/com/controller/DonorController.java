...
public class DonorController {
	...
	@GetMapping("/MainDonorSearch/{id}")
	List<Donor> getMaxSearch(@PathVariable int id){
		return DonorSerImpl.mainSearchValued(id);
	}
	
	@GetMapping("/MainDonorName/{name}")
	List<Donor> getNameSearch(@PathVariable String name){
		return DonorSerImpl.getByTypeName(name);
	}
}
