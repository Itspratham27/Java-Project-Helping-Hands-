...
public class DonationController {
	...
	@GetMapping("/MainDonationSearch/{id}")
	List<Donation> getMaxSearch(@PathVariable int id){
		return DonSerImpl.mainSearchValue(id);
	}
	
	@GetMapping("/MainDonationName/{name}")
	List<Donation> getNameSearch(@PathVariable String name){
		return DonSerImpl.mainSearchTypeDay(name);
	}
}
